...
- One script per WCAG success criterion, incrementally added (30/50 WCAG 2.1 A/AA so far, plus 2 WCAG 2.2 AA criteria — see `checks/` for the current list)
